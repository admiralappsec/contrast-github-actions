...
const downloadContrastSecurity = ( platformType, agentType, customDownloadLocation, URL ) => {
    let incomingCustomDownloadLocation = "";
    ...
    try {
        if (customDownloadLocation != "") {
            console.log('custom download location was detected.  moving forward with string ' + customDownloadLocation + '.');
